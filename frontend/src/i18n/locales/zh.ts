export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      // OAuth 账号 RPM/30m 限制设置
      rpmLimitSettings: '请求频率限制',
      rpmLimitSettingsDesc: '配置 Anthropic 账号的请求频率限制，0 表示使用默认值或不限制',
      maxRpm: '每分钟最大请求',
      maxRpmPlaceholder: '0',
      maxRpmHint: '0 = 使用默认值 (4)',
      max30mRequests: '30分钟最大请求',
      max30mRequestsPlaceholder: '0',
      max30mRequestsHint: '0 = 不限制',
      rateLimitCooldown: '冷却时间（分钟）',
      rateLimitCooldownPlaceholder: '0',
      rateLimitCooldownHint: '触发30分钟限制后的暂停时间',
      expired: '已过期',
      proxy: '代理',
      noProxy: '无代理',
      concurrency: '并发数',
