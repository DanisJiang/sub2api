export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      maxRpm: '每分钟最大请求数 (RPM)',
      maxRpmPlaceholder: '0 = 使用默认值 4',
      maxRpmHint: '限制每分钟的请求数量。0 表示使用默认值（4 次/分钟）',
      max30mRequests: '30 分钟最大请求数',
      max30mRequestsPlaceholder: '0 = 不限制',
      max30mRequestsHint: '30 分钟内允许的最大请求总数。达到限制后账号将暂停调度。0 表示不限制',
