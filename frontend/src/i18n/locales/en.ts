export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      rpmLimitSettings: 'Rate Limiting',
      rpmLimitSettingsDesc: 'Configure rate limits for Anthropic accounts. 0 means use default or no limit',
      maxRpm: 'Max RPM',
      maxRpmPlaceholder: '0',
      maxRpmHint: '0 = use default (4)',
      max30mRequests: 'Max 30m Requests',
      max30mRequestsPlaceholder: '0',
      max30mRequestsHint: '0 = no limit',
      rateLimitCooldown: 'Cooldown (minutes)',
      rateLimitCooldownPlaceholder: '0',
      rateLimitCooldownHint: 'Pause duration after hitting 30m limit',
      expired: 'Expired',
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      concurrency: 'Concurrency',
