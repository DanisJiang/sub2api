export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      maxRpm: 'Max Requests Per Minute (RPM)',
      maxRpmPlaceholder: '0 = use default (4)',
      maxRpmHint: 'Limit requests per minute. 0 uses default value (4 req/min)',
      max30mRequests: 'Max Requests per 30 Minutes',
      max30mRequestsPlaceholder: '0 = no limit',
      max30mRequestsHint: 'Maximum total requests allowed in 30 minutes. Account pauses when limit reached. 0 means no limit',
