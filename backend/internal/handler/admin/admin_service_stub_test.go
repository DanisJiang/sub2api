...
func (s *stubAdminService) ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search string, archived *bool) ([]service.Account, int64, error) {
...
func (s *stubAdminService) SetAccountArchived(ctx context.Context, id int64, archived bool) (*service.Account, error) {
	account := service.Account{ID: id, Name: "account", Status: service.StatusActive, Archived: archived}
	return &account, nil
}
