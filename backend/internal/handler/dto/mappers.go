...
func groupFromServiceBase(g *service.Group) Group {
	...
	// 确保 ModelMapping 不为 nil，避免 JSON 序列化为 null
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		Archived:                 a.Archived,
		RiskControlEnabled:       a.RiskControlEnabled,
		...
		MaxRPM:                   a.MaxRPM,
		Max30mRequests:           a.Max30mRequests,
		RateLimitCooldownMinutes: a.RateLimitCooldownMinutes,
		GroupIDs:                 a.GroupIDs,
	}
