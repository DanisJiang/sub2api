...
func (m *mockAccountRepoForPlatform) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, archived *bool) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
...
func (m *mockAccountRepoForPlatform) SetArchived(ctx context.Context, id int64, archived bool) error {
	return nil
}
...
func (m *mockConcurrencyCache) AcquireAccountSlotByIndex(ctx context.Context, accountID int64, slotIndex int) (bool, error) {
	return true, nil
}

func (m *mockConcurrencyCache) ReleaseAccountSlotByIndex(ctx context.Context, accountID int64, slotIndex int) error {
	return nil
}
...
func (m *mockConcurrencyCache) AcquireSessionMutex(ctx context.Context, accountID int64, sessionHash string, requestID string) (bool, error) {
	return true, nil
}

func (m *mockConcurrencyCache) ReleaseSessionMutex(ctx context.Context, accountID int64, sessionHash string, requestID string) error {
	return nil
}
...
func (m *mockConcurrencyCache) CleanupAllExpiredSlots(ctx context.Context) (int, error) {
	return 0, nil
}

func (m *mockConcurrencyCache) ClearAllSlots(ctx context.Context) (int, error) {
	return 0, nil
}

func (m *mockConcurrencyCache) GetSlotResponseEndTime(ctx context.Context, accountID int64, slotIndex int) (int64, error) {
	return 0, nil
}

func (m *mockConcurrencyCache) GetAccountRPM(ctx context.Context, accountID int64) (int, error) {
	return 0, nil
}

func (m *mockConcurrencyCache) GetAccountOldestRequestTime(ctx context.Context, accountID int64) (int64, error) {
	return 0, nil
}

func (m *mockConcurrencyCache) GetAccountRequestCount30m(ctx context.Context, accountID int64) (int, error) {
	return 0, nil
}

func (m *mockConcurrencyCache) SetAccountPaused(ctx context.Context, accountID int64, duration time.Duration) error {
	return nil
}

func (m *mockConcurrencyCache) IsAccountPaused(ctx context.Context, accountID int64) (bool, error) {
	return false, nil
}

func (m *mockConcurrencyCache) SetSlotResponseEndTime(ctx context.Context, accountID int64, slotIndex int, timestamp int64) error {
	return nil
}

func (m *mockConcurrencyCache) RecordAccountRequest(ctx context.Context, accountID int64) error {
	return nil
}
...
func TestGatewayService_SelectAccountWithLoadAwareness(t *testing.T) {
	...
	t.Run("模型路由-无ConcurrencyService也生效", func(t *testing.T) {
		t.Skip("Model routing in SelectAccountWithLoadAwareness not implemented in local version")
		groupID := int64(1)
		sessionHash := "sticky"
