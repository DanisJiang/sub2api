...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "usage_limit", Type: field.TypeFloat64, Nullable: true},
		{Name: "total_usage", Type: field.TypeFloat64, Default: 0},
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "risk_control_enabled", Type: field.TypeBool, Default: false},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "client_type", Type: field.TypeInt8, Default: 0},
